...
def DatesBeforeCurrentDate(indiListData, famListData):
  ...
  #for individual
    ...
    if(len(dateList) == 0):
        ...
        print("ERROR: INDIVIDUAL: US01: In There dates after the current date. ")
        print(dateList)
...
def main(file_name):
    ...
    indiListData.sort()
    famListData.sort()
    draw_indi_table(indiListData)
    draw_fam_table(famListData) 
...
fileInput= 'C:/Users/Anand/Desktop/h4.ged'
main(fileInput)
